...
const CrearRol = () => {
    ...
    useEffect(() => {
        ...
        } else if (listaRoles && listaRoles.some((element) => element.name === rol.nombre)) {
            setErrors({
                errorFound: true,
            ...
            <FalconComponentCard>
                <FalconComponentCard.Body>
                    <div className='d-flex w-100 align-items-center justify-content-between px-3 mt-4 mb-5'>
                        ...
                        <Breadcrumb>
                            <Breadcrumb.Item onClick={() => navigate('/permisos/roles')}>
                                Gestionar roles
                            </Breadcrumb.Item>
                    ...
                    <form className='d-flex flex-column justify-content-start' onSubmit={handleSubmit}>
                        ...
                        <div className='d-flex flex-row justify-content-end w-100' style={{ gap: 50 }}>
                            ...
                            {ButtonSuccessSubmit('Crear rol', errors.errorFound)}
                        </div>
                    </form>
                </FalconComponentCard.Body>
            </FalconComponentCard>
