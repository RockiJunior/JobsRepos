...
const AceptarInvitacion = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(confirmAccount(userData))
        setTimeout(()=>navigate('/ingresar'), 4500)
    }
    ...
    return (
        <div className='mx-5 my-3 d-flex flex-column align-items-center'>
            ...
            <h5 className='mb-2 text-center'>Para finalizar su registro, debe ingresar su contraseña, la cual</h5>
            <h5 className='text-center'>debe tener entre 8 y 16 dígitos y al menos 1 mayúscula, 1 número y 1 símbolo.</h5>
