...
const ToggleButtonWithLogo = () => {
  ...
  return (
    ...
    >
      <div className="toggle-icon-wrapper m-0 d-flex align-items-center" style={{minWidth:250, width:250}}>
        <Button
          variant="link"
          className="navbar-toggler-humburger-icon navbar-vertical-toggle me-2"
