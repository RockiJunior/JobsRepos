...
@Module({
	imports: [
		...
		MongooseModule.forRoot(
			// mongodb-atlas...
			// `mongodb+srv://${process.env.PROPERTIES_DATABASE_USERNAME}:${process.env.PROPERTIES_DATABASE_PASSWORD}@${process.env.PROPERTIES_DATABASE_HOST}/${process.env.PROPERTIES_DATABASE_NAME}`
			// leo instance...
			`mongodb://${process.env.PROPERTIES_DATABASE_USERNAME}:${process.env.PROPERTIES_DATABASE_PASSWORD}@${process.env.PROPERTIES_DATABASE_HOST}`
		),
		// ------------------------------ LOCAL INSTANCE ------------------------------
		// TypeOrmModule.forRoot({
		// 	type: 'mongodb',
		...
		// 	port: parseInt(`${process.env.PROPERTIES_DATABASE_PORT}`),
		// 	username: `${process.env.PROPERTIES_DATABASE_USERNAME}`,
		// 	password: `${process.env.PROPERTIES_DATABASE_PASSWORD}`,
		// 	database: `${process.env.PROPERTIES_DATABASE_NAME}`,
		// 	entities: [Property],
		// 	synchronize: true,
		// 	useUnifiedTopology: true,
		// }),
		// MongooseModule.forRoot(
		// 	`mongodb://${process.env.PROPERTIES_DATABASE_HOST}:${process.env.PROPERTIES_DATABASE_PORT}/${process.env.PROPERTIES_DATABASE_NAME}`
		// ),
		// ------------------------------------------------------------------------------
