...
import { readMessage } from "../../redux/messagesSlice";
moment.locale("es");

const ListComponent = ({ chat, setCurrentChat, currentChat, refreshList, setRefreshList }) => {
  const dispatch = useDispatch()
  const lastMsg = chat.messages[chat.messages.length - 1];
  const lastMsgRead = (lastMsg.user && lastMsg.read_at) || !lastMsg.user ? true : false
        ...
        <div className="wrap">
          ...
          <div className="child-wrap df">
            <div className="meta">
              ...
              <p style={{fontWeight: !lastMsgRead && "bold"}} className="preview">
                {!lastMsg.user && "Tú: "}
