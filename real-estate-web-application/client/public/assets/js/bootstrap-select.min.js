	...
	$.fn.searchBox = function(opts) {
		...
		var init = function (obj) {
			...
			var changeSearchBoxElement = function() {
				...
				parent.find('.searchBoxElement').find('li').on('click',function(e){
					e.preventDefault();
					// e.stopPropagation();
					var li = $(this),
