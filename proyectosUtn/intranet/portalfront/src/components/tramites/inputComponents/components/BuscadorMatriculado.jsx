...
import { getMatriculados } from 'redux/actions/tramite';
...
const BuscadorMatriculado = ({
  ...
  const { matriculados } = useSelector(state => state.tramiteReducer);
