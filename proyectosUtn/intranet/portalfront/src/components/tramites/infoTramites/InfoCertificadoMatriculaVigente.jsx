...
const InfoCertificadoMatriculaVigente = () => {
  const { user } = useSelector(state => state.authReducer);
  const { lastProcedure } = useSelector(state => state.tramiteReducer);

  const idTipoTramite = tramites.certificadoMatriculaVigente;
...
export default InfoCertificadoMatriculaVigente;
