...
const InfoAltaMatriculaCesantia = () => {
  const { user } = useSelector(state => state.authReducer);
  const { lastProcedure } = useSelector(state => state.tramiteReducer);

  const idTipoTramite = tramites.altaMatriculacionCesantia;
  ...
  return (
    <div className="container">
      ...
      >
        ...
        >
          Alta de Matriculación (Retira la cesantía)
        </h4>
        <div>
          {isRegistred ? (
...
export default InfoAltaMatriculaCesantia;
