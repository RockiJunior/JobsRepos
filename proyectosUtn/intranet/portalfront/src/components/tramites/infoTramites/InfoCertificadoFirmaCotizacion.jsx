...
const InfoCertificadoFirmaCotizacion = () => {
  const { user } = useSelector(state => state.authReducer);
  const { lastProcedure } = useSelector(state => state.tramiteReducer);

  const idTipoTramite = tramites.certificadoFirmaCotizaciones;
  ...
  return (
    <div className="container">
      ...
      >
        ...
        >
          Certificado Firma Cotizaciones
        </h4>
        <div>
          {isRegistred ? (
...
export default InfoCertificadoFirmaCotizacion;
