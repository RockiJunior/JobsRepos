...
import { tramiteGetById, tramitesEliminarNota } from 'redux/actions/tramite';
    ...
    >
      ...
      {user.id === note.empleadoId && (
        <div
          ...
          onClick={async () => {
            await dispatch(tramitesEliminarNota(note.id));
            await dispatch(tramiteGetById(note.tramiteId));
          }}
        >
