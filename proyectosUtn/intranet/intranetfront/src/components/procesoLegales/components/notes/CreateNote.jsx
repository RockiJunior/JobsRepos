...
import { procesoLegalesCrearNota } from 'redux/actions/procesoLegales';

const CreateNote = ({ setCreate, procesoLegalId, onSubmit, expedienteId }) => {
      ...
      <div className="d-flex justify-content-end mt-2">
        ...
        >
          <Button
            ...
            onClick={async () => {
              await dispatch(
                procesoLegalesCrearNota(procesoLegalId, descripcion)
              );
...
CreateNote.propTypes = {
  ...
  procesoLegalId: PropType.number.isRequired,
