    ...
    >
      <div className="border p-2">
        ...
        <div
          ...
          style={{
            justifyContent:
              user.id === document.empleado.usuarioId ? 'space-between' : 'end'
          }}
        >
          {user.id === document.empleado.usuarioId && !noEdit && (
            <div className="d-flex justify-content-end mt-3">
              <Button
                ...
                onClick={async () => {
                  ...
                  await dispatch(expedienteGetById(document.expedienteId));
                }}
              >
                Eliminar
              </Button>
...
DocumentComponent.propTypes = {
  ...
  type: PropTypes.oneOf(['informe', 'dictamen', 'resolucion', 'fallo']),
