...
import { confirmRegistrationToken } from "../redux/loginSlice";
...
const ConfirmationPage = () => {
  ...
  const HandleSubmit = async (values) => {
    ...
    const res = await dispatch(confirmRegistrationToken(data));
    setResponse(res);
    setIsLoading(false);
    messageHandler(
      "success",
      "¡Tu cuenta está activada! Ahora te redirigimos para que inicies sesión."
    );
      ...
      >
        {!response ? (
          <div className="col-sm-8 col-md-6">
            <h1 className="mb-4">Crear contraseña</h1>
