...
export class addPartnersFields1642133315270 implements MigrationInterface {
  name = 'addPartnersFields1642133315270';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "partners" ADD "birthPlace" character varying(255)`);
    await queryRunner.query(`ALTER TABLE "partners" ADD "gender" character varying(255)`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`COMMENT ON COLUMN "loaded_partners"."updateAt" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "loaded_partners"."createAt" IS NULL`);
    await queryRunner.query(`ALTER TABLE "partners" DROP COLUMN "gender"`);
    await queryRunner.query(`ALTER TABLE "partners" DROP COLUMN "birthPlace"`);
  }
}
