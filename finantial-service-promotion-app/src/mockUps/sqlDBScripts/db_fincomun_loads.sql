...
CREATE TABLE `loads` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_8557947ee0f2e889f48dbe9e0c4` (`userId`),
  CONSTRAINT `FK_8557947ee0f2e889f48dbe9e0c4` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
-- Dump completed on 2022-10-10 11:05:51
